            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span>github.com/sarbeswarpanda04</span>
                </a>
                <a
                  href="https://linkedin.com/in/sarbeswar-panda"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                >
                  <Linkedin className="w-6 h-6" />
                  <span>linkedin.com/in/sarbeswar-panda</span>
                </a>
              </div>
            </div>
